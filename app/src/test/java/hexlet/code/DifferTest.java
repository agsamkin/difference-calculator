...
public class DifferTest {
    ...
    void generatePlainTest() throws Exception {
        ...
        String expected1 = FilesUtil.readFile(PLAIN_EXPECTED);
        Assertions.assertEquals(expected1, actual1);

        String actual2 = Differ.generate(YML_FILE_1, YML_FILE_2, "plain");
        String expected2 = FilesUtil.readFile(PLAIN_EXPECTED);
        Assertions.assertEquals(expected2, actual2);
    }
    ...
    void generateJsonTest() throws Exception {
        ...
        String expected1 = FilesUtil.readFile(JSON_EXPECTED);
        Assertions.assertEquals(expected1, actual1);

        String actual2 = Differ.generate(YML_FILE_1, YML_FILE_2, "json");
        String expected2 = FilesUtil.readFile(JSON_EXPECTED);
        Assertions.assertEquals(expected2, actual2);
    }
}
